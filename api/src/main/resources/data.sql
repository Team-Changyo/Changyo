...
values ('110184999999', 331551, '088', '김신한', '예금'),
       ('110280999999', 10000, '088', '전인혁', '예금'),
       ('110281999999', 270000, '088', '전인혁', '예금'),
       ('110282999999', 410000, '088', '전인혁', '예금'),
       ('110283999999', 530000, '088', '최영환', '예금'),
       ('110284999999', 670000, '088', '최영환', '예금'),
       ('110285999999', 780000, '088', '최영환', '예금'),
       ('110286999999', 790000, '088', '임우택', '예금'),
       ('110287999999', 810000, '088', '임우택', '예금'),
       ('110288999999', 830000, '088', '임우택', '예금'),
       ('110289999999', 900000, '088', '홍진식', '예금'),
       ('110290999999', 940000, '088', '홍진식', '예금'),
       ('110291999999', 980000, '088', '홍진식', '예금');
